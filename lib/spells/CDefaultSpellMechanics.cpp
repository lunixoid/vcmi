...
void SpellCastContext::addCustomEffect(const battle::Unit * target, ui32 effect)
{
...
bool DefaultSpellMechanics::isImmuneByStack(const battle::Unit * obj) const
{
...
{
	std::vector<const battle::Unit *> affected;
